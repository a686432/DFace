...
def mobilenet_1(num_classes=135, input_channel=3):
    model = MobileNet(
...
def mobilenet_075(num_classes=135, input_channel=3):
    model = MobileNet(
...
def mobilenet_05(num_classes=135, input_channel=3):
    model = MobileNet(
...
def mobilenet_025(num_classes=135, input_channel=3):
    model = MobileNet(
