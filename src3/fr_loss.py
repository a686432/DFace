...
class Arcface(Module): 
    def __init__(self, embedding_size=512, classnum=8631,  s=64., m=0.5):
...
class CenterLoss(nn.Module):
    ...
    def forward(self, y, hidden, ind=None, weights=None):
        ...
        if ind is None:
            ...
            intra_distances = torch.sum((hidden - expanded_centers)**2,dim=1).reshape(batch_size,1)*ind.reshape(batch_size,1)
